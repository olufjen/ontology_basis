...
//		int start = 2;
	...
	/**
	 * createRuleString
	 * This method creates a rule string based on the toString of the rule predicate and rule body.
	 * @param predicate
	 * @param rule
	 * @return a rule string
	 */
	public String createRuleString(String predicate, String rule) {
  	  char sep = '#';char sep2 = '/';char sep3 = '.';char sep4 = '>';
...
//  	  System.out.println("Createrulestring: "+predtemp+ " : " +predtt+ " variables: "+vars);
	...
	/**
	 * createRuleLabel
	 * This method returns the name of a rule given the .toString ruleAnnotation
